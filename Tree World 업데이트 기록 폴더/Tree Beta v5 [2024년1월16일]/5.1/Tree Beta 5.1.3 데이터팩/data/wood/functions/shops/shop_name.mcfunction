...
execute if score n shopname matches 10 run tag @e[type=minecraft:villager] remove normal9
...
execute if score n shopname matches 15 run execute as @e[tag=normal_9] at @s run tag @e[type=minecraft:villager,limit=1,sort=nearest] add normal9
...
execute if score n shopname matches 20 run data merge entity @e[tag=normal9,limit=1,type=minecraft:villager] {CustomNameVisible:1b,CustomName:'[{"text":"아이템 환불","color":"gold"}]'}
...
# 낚시터
execute if score n shopname matches 10 run tag @e[type=minecraft:villager] remove fish1
execute if score n shopname matches 10 run tag @e[type=minecraft:villager] remove fish2
execute if score n shopname matches 15 run execute as @e[tag=fish_1] at @s run tag @e[type=minecraft:villager,limit=1,sort=nearest] add fish1
execute if score n shopname matches 15 run execute as @e[tag=fish_2] at @s run tag @e[type=minecraft:villager,limit=1,sort=nearest] add fish2
execute if score n shopname matches 20 run data merge entity @e[tag=fish1,limit=1,type=minecraft:villager] {CustomNameVisible:1b,CustomName:'[{"text":"어부","color":"gold"}]'}
execute if score n shopname matches 20 run data merge entity @e[tag=fish2,limit=1,type=minecraft:villager] {CustomNameVisible:1b,CustomName:'[{"text":"낚싯대 전문가","color":"gold"}]'}