...
# 낚시터
particle minecraft:composter 29000002.5 250.1 28999995.5 0.3 0.05 0.3 0 10 force
particle minecraft:composter 29000004.5 250.1 -28999999.5 0.3 0.05 0.3 0 10 force
execute as @a[x=29000002,y=250,z=28999995,dx=0,dy=0,dz=0] run tp @s 29000000 250 -29000000
execute as @a[x=29000004,y=250,z=-29000000,dx=0,dy=0,dz=0] run tp @s 29000000.5 250 29000000.5
function wood:fish_main

# 준비중......
#particle minecraft:composter 28999998.5 250.1 28999995.5 0.3 0.05 0.3 0 10 force
#execute as @a[x=28999998,y=250,z=28999995,dx=0,dy=0,dz=0] run tp @s 29000000 250 0
...
# Tree World 보너스
execute store result bossbar minecraft:tree value run scoreboard players get T Tree_bonus
execute as @a[scores={Tree_bonus=1..}] run scoreboard players add T Tree_bonus 1
execute as @a[scores={Tree_bonus=1..}] run scoreboard players set @s Tree_bonus 0
execute if score T Tree_bonus >= 100000 num run give @a gold_ingot 2
execute if score T Tree_bonus >= 100000 num run title @a actionbar {"text":"+ 금괴 2개 (Tree World 보너스)","color":"gold","bold":true}
execute if score T Tree_bonus >= 100000 num at @a run playsound minecraft:entity.firework_rocket.twinkle_far master @a ~ ~ ~ 1 1
execute if score T Tree_bonus >= 100000 num run scoreboard players set T Tree_bonus 0
...
execute as @a[scores={Revent=5701..5705}] if score @s 300Revent matches 300 run title @s title {"text":"✯ 겉날개 ✯","color":"gold"}
...
# 팀
execute as @a unless score @s rank >= 0 num run scoreboard players set @s rank 0
execute as @a if score @s rank matches 0 run team join newbe @s
...
execute as @a[scores={new=2}] run give @s minecraft:stick{CanDestroy:["minecraft:oak_leaves","minecraft:oak_log"],display:{Name:'[{"text":"단단한 막대기","italic":false,"bold":true,"color":"aqua"}]',Lore:['[{"text":"맨손으로 나무캐는건 말이 안돼지..!","italic":false,"color":"#abffab"}]']}}
...
execute as @a[scores={wood=100000..},team=newbe] at @s run function wood:rankup
...
execute as @a[scores={wood=200000..},team=1] at @s run function wood:rankup
...
execute as @a[scores={wood=400000..},team=2] at @s run function wood:rankup
...
execute as @a[scores={wood=700000..},team=3] at @s run function wood:rankup
...
execute as @a[scores={wood=1000000..},team=4] at @s run function wood:rankup
...
execute as @a[scores={diamond_axe=1..}] at @s store result score @s tempwood2 run fill ~2 ~2 ~2 ~-2 ~ ~-2 air replace oak_log
...
execute as @a[scores={netherite_axe=1..}] at @s store result score @s tempwood2 run fill ~3 ~2 ~3 ~-3 ~ ~-3 air replace oak_log
...
# 도끼에너지 (주변 나무 폭발)
execute as @a[nbt={Inventory:[{id:"minecraft:fire_charge",Slot:-106b,Count:1b}]}] at @s store result score @s tempwood2 run fill ~2 100 ~2 ~-2 -64 ~-2 air replace oak_log
execute as @a[nbt={Inventory:[{id:"minecraft:fire_charge",Slot:-106b,Count:1b}]}] store result score @s tempwood run scoreboard players get @s tempwood2
execute as @a[nbt={Inventory:[{id:"minecraft:fire_charge",Slot:-106b,Count:1b}]}] at @s run particle minecraft:cloud ~ ~1 ~ 0.5 0.3 0.5 0 20 force
execute as @a[nbt={Inventory:[{id:"minecraft:fire_charge",Slot:-106b,Count:1b}]}] at @s run playsound minecraft:block.wood.break master @s ~ ~ ~ 1 1
execute as @a[nbt={Inventory:[{id:"minecraft:fire_charge",Slot:-106b,Count:1b}]}] at @s run playsound minecraft:block.wood.break master @s ~ ~ ~ 1 1
execute as @a[nbt={Inventory:[{id:"minecraft:fire_charge",Slot:-106b,Count:1b}]}] at @s run playsound minecraft:block.wood.break master @s ~ ~ ~ 1 1
execute as @a[nbt={Inventory:[{id:"minecraft:fire_charge",Slot:-106b,Count:1b}]}] at @s run tellraw @s {"text":"주변 나무 폭발!","color":"aqua"}
execute as @a[nbt={Inventory:[{id:"minecraft:fire_charge",Slot:-106b,Count:1b}]}] at @s run item replace entity @s weapon.offhand with minecraft:air
...
execute as @a[nbt={Inventory:[{id:"minecraft:iron_chestplate",Count:1b,Slot:102b,tag:{Trim:{material:"minecraft:quartz",pattern:"minecraft:wayfinder"}}}]}] unless entity @s[nbt={Inventory:[{id:"minecraft:iron_leggings",Count:1b,Slot:101b}]}] if score @s fevernow >= @s feverset run effect give @s haste 20 4
execute as @a[nbt={Inventory:[{id:"minecraft:iron_chestplate",Count:1b,Slot:102b,tag:{Trim:{material:"minecraft:emerald",pattern:"minecraft:wayfinder"}}}]}] unless entity @s[nbt={Inventory:[{id:"minecraft:iron_leggings",Count:1b,Slot:101b}]}] if score @s fevernow >= @s feverset run effect give @s haste 20 5
execute as @a[nbt={Inventory:[{id:"minecraft:iron_chestplate",Count:1b,Slot:102b,tag:{Trim:{material:"minecraft:gold",pattern:"minecraft:wayfinder"}}}]}] unless entity @s[nbt={Inventory:[{id:"minecraft:iron_leggings",Count:1b,Slot:101b}]}] if score @s fevernow >= @s feverset run effect give @s haste 20 6
