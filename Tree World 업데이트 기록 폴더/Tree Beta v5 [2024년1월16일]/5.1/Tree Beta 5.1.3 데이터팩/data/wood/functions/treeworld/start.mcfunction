...
# 낚시터
forceload add 29000013 -28999996 28999991 -29000032
...
scoreboard objectives add Tree_bonus minecraft.mined:minecraft.oak_log
...
scoreboard objectives add use_wooden_axe minecraft.used:minecraft.wooden_axe
scoreboard objectives add fish minecraft.custom:minecraft.fish_caught
scoreboard objectives add fish_R dummy
...
scoreboard objectives add A_hidden_3_boom dummy
scoreboard objectives add A_hidden_4 dummy
scoreboard objectives add A_hidden_4_wood minecraft.mined:minecraft.oak_log
scoreboard objectives add A_hidden_5 dummy
scoreboard objectives add A_hidden_6 dummy
scoreboard objectives add A_hidden_7 dummy
scoreboard objectives add A_hidden_7_R dummy
scoreboard objectives add A_hidden_7_wood minecraft.mined:minecraft.oak_log
...
bossbar add tree ""
bossbar set minecraft:tree max 100000
bossbar set minecraft:tree color white
bossbar set minecraft:tree style notched_10
